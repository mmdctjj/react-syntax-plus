...
![props](https://github.com/mmdctjj/react-syntax-plus/blob/master/images/props.png?raw=true)

Of course, if you have already deconstructed props, the deconstructed properties will be automatically recognized, such as:

![props](https://github.com/mmdctjj/react-syntax-plus/blob/master/images/deconstructed.png?raw=true)
